...
//                return;
//            } else if (speed < 0d && Sensor.Encoders.PICKUP
//                    .get() < -290d /* found by trial and error */) {
//                Motors.PICKUP.set(0.1);
//                return;
//            }
//        } else {
...
//        }
         ...
         * if(speed/Sensor.Encoders.PICKUP.getRate()!=rate){ Robot.log(
         * "ratio = " + speed/Sensor.Encoders.PICKUP.getRate()); rate =
         * speed/Sensor.Encoders.PICKUP.getRate(); }
         */
